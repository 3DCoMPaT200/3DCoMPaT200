...
def plot_confusion_matrix(
    ...
    # Save the figure
    plt.savefig(os.path.join(LOG_DIR, save_path))
    # plt.show()
...
def parse_args():
    ...
    parser.add_argument(
        "--lang", action="store_true", default=False, help="use normals"
    )
    parser.add_argument(
        "--mps", action="store_true", default=False, help="use MPS Sampler"
    )
    parser.add_argument(
        "--pretrain", action="store_true", default=False, help="use normals"
    )
    parser.add_argument(
