...
def main(args):
    ...
    exp_dir = Path("/home/ahmems0a/repos/3DCoMPaT200/models/3D/log2/")
    ...
    for subset in [None]:
        ...
        with torch.no_grad():
            ...
            np.save(args.data_name+'_'+args.model+'_shape_prior_part_pred.npy', all_predictions)  # Save as NumPy array
